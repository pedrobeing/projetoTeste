// Animações
window.addEventListener('load',function(){AOS.init({duration:2000,offset:120})});/*
...
$('.owl-carousel-produtos').owlCarousel({margin:20,nav:false,autoplay:false,dots:true,responsive:{0:{items:1},768:{items:2},1000:{items:3}}});// Scroll Nav
function sectionScroll(index){var targetOffset=$(index).offset().top;var variacao=30;$('html, body').animate({scrollTop:targetOffset-variacao},3000)}// Scroll Menu Header
...
$('.mask_phone_with_ddd').mask('(00) 00000-0000');$('.mask_cpf').mask('000.000.000-00');$('.mask_cnpj').mask('00.000.000/0000-00');//$('.mask_spcelphones').mask(SPMaskBehavior, spOptions);
var CpfCnpjMaskBehavior=function(val){return val.replace(/\D/g,'').length<=11?'000.000.000-0099':'00.000.000/0000-00'},cpfCnpjOptions={onKeyPress:function(val,e,field,options){field.mask(CpfCnpjMaskBehavior.apply({},arguments),options)}};$('.mask_cpfcnpj').mask(CpfCnpjMaskBehavior,cpfCnpjOptions);var wpcf7Elm=document.querySelector('.wpcf7');wpcf7Elm.addEventListener('wpcf7mailsent',function(event){fbq('track','Lead');gtag('event','conversion',{'send_to':'AW-315790915/Fn-4CIKJ_PUCEMOsypYB'});$('html, body').animate({scrollTop:$('#s-intro-home').offset().top-50},'slow')},false);